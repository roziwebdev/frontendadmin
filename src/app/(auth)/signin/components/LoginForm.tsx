...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r bg-base-100">
      <div className="card w-full max-w-sm shadow-xl bg-white rounded-lg">
        <div className="card-body p-8">
          ...
          <div className="form-control mb-2">
            <label className="label">
              <span className="label-text text-indigo-600 font-semibold">Email</span>
            </label>
            <Input
              value={email}
          ...
          <div className="form-control mb-3">
            <label className="label">
              <span className="label-text text-indigo-600 font-semibold">Password</span>
            </label>
            <Input
              value={password}
          ...
          <div className="text-center mt-4">
            <Link href="/signup" className="text-indigo-500 hover:text-indigo-700">
